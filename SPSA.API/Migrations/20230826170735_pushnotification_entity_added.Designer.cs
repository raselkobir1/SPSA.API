...
namespace SPSA.API.Migrations
{
    ...
    [Migration("20230826170735_pushnotification_entity_added")]
    partial class pushnotification_entity_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPSA.API.Domain.Entitys.PushNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PushNotifications", "dbo");
                });
            ...
            modelBuilder.Entity("SPSA.API.Domain.Entitys.PushNotification", b =>
                {
                    b.HasOne("SPSA.API.Domain.User", "ReadByUser")
                        .WithMany()
